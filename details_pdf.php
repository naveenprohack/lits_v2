        ...
        <table class="w-full border-collapse border-spacing-0">
          <tbody>
            <tr>
              ...
              <div>
  <img src="image/Logo" alt="Company Logo" class="h-12">
</div>
              </td>
            ...
            <tr>
              <td class="w-1/2 align-top">
                <div class="text-sm text-neutral-600">
                  <p class="font-bold">Learn institute of technology service</p>
                  <p> +91 9786302865</p>
                  <p>singapore</p>
                </div>
              </td>
        ...
        <table class="w-full border-collapse border-spacing-0">
          <thead>
            <tr>
              ...
              <td class="border-b-2 border-main pb-3 pl-2 font-bold text-main">Course details</td>
