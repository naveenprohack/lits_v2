    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myMenu">
            <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <div class="mega-menu">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <a class="dropdown-item" href="https://litsedu.com/Python-Online-Training">Python Programming</a>
                                <a class="dropdown-item" href="https://litsedu.com/Data-Science-Online-Training">Data Science</a>
                                <a class="dropdown-item" href="https://litsedu.com/Python-Full-Stack-Development-Online-Training">Full Stack</a>
                                <a class="dropdown-item" href="https://litsedu.com/Artifical-Intelligence-Online-Training">Artificial Intelligence</a>
                                <a class="dropdown-item" href="https://litsedu.com/Software-testing-Online-Training">Software Testing</a>
                            </div>
                            
                            <div class="col-md-3">
                                <h6><i class="fas fa-chart-line me-2"></i>Business</h6>
                                <a class="dropdown-item" href="https://litsedu.com/Supply-Chain-Management-Online-Training">Supply Chain</a>
                                <a class="dropdown-item" href="https://litsedu.com/Tally-Erp-Online-Training">Tally ERP</a>
                                <a class="dropdown-item" href="https://litsedu.com/Digital-Marketing-Online-Training">Digital Marketing</a>
                                <a class="dropdown-item" href="https://litsedu.com/Advanced-Excel-Online-Training">Advanced Excel</a>
                            </div>

                            <div class="col-md-3">
                                <h6><i class="fas fa-paint-brush me-2"></i>Design</h6>
                                <a class="dropdown-item" href="https://litsedu.com/photoshop">Photoshop</a>
                                <a class="dropdown-item" href="https://litsedu.com/Graphic-Design-Online-Training">Graphic Design</a>
                                <a class="dropdown-item" href="https://litsedu.com/Adobe-Premiere-Pro-Online-Training">Premiere Pro</a>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <a class="dropdown-item" href="https://litsedu.com/React-Online-Training.">React JS</a>
                                <a class="dropdown-item" href="https://litsedu.com/Mean-Stack-Online-Training">Mean Stack</a>
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-outline-primary ms-lg-3" href="https://litsedu.com/contact1" style="border-color: #0ca6a3; color: #f4f4f4ff; border-radius: 20px; padding: 5px 20px !important;">Contact</a>
                </li>
            </ul>
        </div>
    </div>
