...
<head>
    ...
    <title>Learn Institute of Technology Service |placement </title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
@media (max-width: 768px) {
    ...
    .profile-pic {
        margin-right: 0; /* Removes the side margin used for desktop */
        margin-bottom: 15px; /* Adds space between image and text */
    }

    .testimonial-text {
        font-size: 16px; /* Slightly smaller text for better mobile fit */
    }
}
    </style>
</head>
